# AGENTS.md - Ingest Developer & AI Agent Guide

Welcome to `ingest`. This repository is designed to be **AI-first, highly modular, and zero-dependency**.
...
- **AI Providers**: [`src/ai/factory.ts`](file:///Users/tsuzuku/Git/ingest/main/src/ai/factory.ts), [`src/ai/antigravity.ts`](file:///Users/tsuzuku/Git/ingest/main/src/ai/antigravity.ts), [`src/ai/opencode.ts`](file:///Users/tsuzuku/Git/ingest/main/src/ai/opencode.ts), [`src/ai/gemini-cli.ts`](file:///Users/tsuzuku/Git/ingest/main/src/ai/gemini-cli.ts), [`src/ai/prompt.ts`](file:///Users/tsuzuku/Git/ingest/main/src/ai/prompt.ts).
...
- **Skill Installer**: [`src/skill/installer.ts`](file:///Users/tsuzuku/Git/ingest/main/src/skill/installer.ts), [`skills/ingest/SKILL.md`](file:///Users/tsuzuku/Git/ingest/main/skills/ingest/SKILL.md).
...
2. **Self-Documentation Rule**: Whenever changes are made to CLI arguments, configuration schemas, or module interfaces, you MUST update:
   ...
   - [`skills/ingest/SKILL.md`](file:///Users/tsuzuku/Git/ingest/main/skills/ingest/SKILL.md)
